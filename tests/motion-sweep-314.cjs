...
fs.writeFileSync('docs/motion-sweep-314.json',JSON.stringify(results,null,2));console.log('PASS '+results.length+' angle/refresh A/B cases: identical attachment cells; faster travel');
