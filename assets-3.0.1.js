...
function syncMusic(){
 const wanted=scene==='menu'?'music_main_menu':scene==='gameplay'?'music_gameplay_loop':null;
...
function setMusic(enabled){musicWanted=enabled;if(enabled)scene='gameplay';syncMusic()}
